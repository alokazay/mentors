...
<head>
    ...
    <title>Курсы Front End - З нуля до фахівця</title>
    ...
    <link rel="apple-touch-icon" href="{{url('/')}}/assets/landing/images/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="72x72" href="{{url('/')}}/assets/landing/images/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="{{url('/')}}/assets/landing/images/apple-touch-icon-114x114.png">

    <!-- ==============================================
    Vendor Stylesheet
    =============================================== -->
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/vendor/slider.min.css">
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/main.css">
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/vendor/icons.min.css">
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/vendor/animation.min.css">
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/vendor/gallery.min.css">
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/vendor/cookie-notice.min.css">

    <!-- ==============================================
    Custom Stylesheet
    =============================================== -->
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/default.css">
    <link rel="stylesheet" href="{{url('/')}}/assets/landing/css/theme-orange.css">
    ...
    <nav data-aos="zoom-out" data-aos-delay="800" class="navbar navbar-expand">
        <div class="container header">
            ...
            <a class="navbar-brand" href="/">
                ...
                <!--
                    Custom Logo
                    <img src="{{url('/')}}/assets/landing/images/logo.svg" alt="Leverage">
                -->
            </a>
            ...
            <ul class="navbar-nav items">
                <li class="nav-item dropdown">
                    <a href="#header" class="nav-link smooth-anchor">Home <i class="icon-arrow-down"></i></a>
                ...
                <li class="nav-item">
                    <a href="#funfacts" class="nav-link smooth-anchor">Fun Facts</a>
                </li>
                <li class="nav-item">
    ...
    <div class="swiper-container full-slider featured animation slider-h-100">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide-center">
                <img data-aos="zoom-out-up" data-aos-delay="800" src="{{url('/')}}/assets/landing/images/hero-4.jpg" class="hero-image" alt="Hero Image">
                <div class="slide-content row" data-mask-768="50">
                    <div class="col-12 d-flex inner">
                        <div class="left align-self-center text-center text-md-left">
                            ...
                            <p data-aos="zoom-out-up" data-aos-delay="800" class="description">We work with the most innovative solutions on the market to help you get the best results.</p>
            ...
            <!-- Item 2 -->
            <div class="swiper-slide slide-center">
                <img data-aos="zoom-out-up" data-aos-delay="800" src="{{url('/')}}/assets/landing/images/hero-5.jpg" class="hero-image" alt="Hero Image">
                <div class="slide-content row" data-mask-768="50">
                    <div class="col-12 d-flex inner">
                        <div class="left align-self-center text-center text-md-left">
                            <h2 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">Boost your Creativity.</h2>
                            <p data-aos="zoom-out-up" data-aos-delay="800" class="description">Escape the fad and discover our creative services that will give authority to your brand.</p>
                            <a href="#contact" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor ml-auto mr-auto ml-md-0 mt-4 btn dark-button"><i class="icon-cup"></i>GET STARTED</a>
                        </div>
                    </div>
                </div>
            ...
            <!-- Item 3 -->
            <div class="swiper-slide slide-center">
                <img data-aos="zoom-out-up" data-aos-delay="800" src="{{url('/')}}/assets/landing/images/hero-6.jpg" class="hero-image" alt="Hero Image">
                <div class="slide-content row" data-mask-768="50">
                    <div class="col-12 d-flex inner">
                        <div class="left align-self-center text-center text-md-left">
                            <h2 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">Reach the<br>Next Level.</h2>
                            <p data-aos="zoom-out-up" data-aos-delay="800" class="description">Are you ready? Count on us to revolutionize your company's online identity.</p>
                            <a href="#contact" data-aos="zoom-out-up" data-aos-delay="1200" class="smooth-anchor ml-auto mr-auto ml-md-0 mt-4 btn dark-button"><i class="icon-cup"></i>GET STARTED</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="gallery col-12 col-md-6">
                <a href="{{url('/')}}/assets/landing/images/about-4.jpg">
                    <img src="{{url('/')}}/assets/landing/images/about-4.jpg" class="fit-image" alt="About Us">
                </a>
            </div>
        </div>
    </div>
...
<section id="video" class="section-2 odd highlights image-left">
    <div class="container">
        <div class="row">
            <div class="gallery col-12 col-md-6">
                <a data-poster="{{url('/')}}/assets/landing/images/about-5.jpg" href="https://www.youtube.com/watch?v=7e90gBu4pas">
                    <i class="play-video icon-control-play"></i>
                    <div class="mask-radius"></div>
                    <img src="{{url('/')}}/assets/landing/images/about-5.jpg" class="fit-image" alt="Institutional">
                </a>
            </div>
            <div class="col-12 col-md-6 pl-md-5 align-self-center text-center text-md-left">
                <div class="row intro">
                    <div class="col-12 p-0">
                        <h2 class="featured alt">Institutional</h2>
        ...
        <form action="php/form.php" id="leverage-form" class="multi-step-form">
            ...
            <div class="row">
                ...
                <div class="content-images col-12 col-md-6 pl-md-5 d-none d-md-block">
                    ...
                    <!-- Step 1 -->
                    <div class="gallery">
                        <a class="step-image" data-poster="{{url('/')}}/assets/landing/images/about-8.jpg" href="https://www.youtube.com/watch?v=7e90gBu4pas">
                            <i class="play-video icon-control-play"></i>
                            <div class="mask-radius"></div>
                            <img src="{{url('/')}}/assets/landing/images/about-8.jpg" class="fit-image" alt="Contact Us">
                        </a>
                    </div>

                    <!-- Step 2 -->
                    <div class="gallery">
                        <a class="step-image" href="{{url('/')}}/assets/landing/images/about-6.jpg">
                            <img src="{{url('/')}}/assets/landing/images/about-6.jpg" class="fit-image" alt="Contact Us">
                        </a>
                    </div>

                    <!-- Step 3 -->
                    <div class="gallery">
                        <a class="step-image" href="{{url('/')}}/assets/landing/images/about-7.jpg">
                            <img src="{{url('/')}}/assets/landing/images/about-7.jpg" class="fit-image" alt="Contact Us">
                        </a>
                    </div>

                    <!-- Step 4 -->
                    <div class="gallery">
                        <a class="step-image" href="{{url('/')}}/assets/landing/images/about-leverage.jpg">
                            <img src="{{url('/')}}/assets/landing/images/about-leverage.jpg" class="fit-image" alt="Contact Us">
                        </a>
                    </div>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        ...
                                        <span class="__cf_email__" data-cfemail="0b636e6767644b697e7862656e787825686466">[email&#160;protected]</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
...
Vendor Scripts
=============================================== -->
<script src="{{url('/')}}/assets/landing/js/vendor/jquery.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/jquery.easing.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/jquery.inview.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/popper.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/bootstrap.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/ponyfill.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/slider.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/animation.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/progress-radial.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/bricklayer.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/gallery.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/shuffle.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/cookie-notice.min.js"></script>
<script src="{{url('/')}}/assets/landing/js/vendor/particles.min.js"></script>
